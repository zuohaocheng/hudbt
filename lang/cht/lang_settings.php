...
(
	...
	'row_view_confi_forum_log' => "查看機密論壇日誌",
	'text_view_confi_forum_log_note' => "查看設計操作机密论坛帖子的日誌。",
	...
	'row_random_sticky' => "隨機置頂設置",
	'text_when_less_than' => "當固定置頂種子數少於",
	'text_will_pick_random' => "個時，將從隨機置頂種子中挑選來補足。",
	'text_random_will_not_be_limit' => "當固定置頂種子數超過這個數目時，則不會挑選隨機種子。<br>",
	'text_sticky_limit_default' => "默認'7'.",
	...
	'row_oday_bot_id' => "0day機器人id",
	'row_oday_forum_id' => "0day訊息論壇id",
	...
	'text_oday_bot_id' => "0day機器人的id，請單擊機器人的名字查看。",
	'text_oday_forum_id' => "0day訊息論壇的id，請點擊該論壇查看。",
