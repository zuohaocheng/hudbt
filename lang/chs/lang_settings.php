...
(
	...
	'row_view_confi_forum_log' => "查看机密论坛日志",
	'text_view_confi_forum_log_note' => "查看涉及操作机密论坛帖子的日志。",
	...
	'text_large_torrent_promotion_note' => "默认'20'，'免费'。将种子体积设为'0'来禁止此规则。大体积种子不参与前述随机优惠。",
	'text_random_timeout' => '秒, 0代表按照全局设置',
	...
	'row_random_sticky' => "随机置顶设置",
	'text_when_less_than' => "当固定置顶种子数少于",
	'text_will_pick_random' => "个时，将从随机置顶种子中挑选来补足。",
	'text_random_will_not_be_limit' => "当固定置顶种子超过这个数目时，则不会挑选随机种子。<br>",
	'text_sticky_limit_default' => "默认'7'.",
	...
	'row_oday_bot_id' => "0day机器人id",
	'row_oday_forum_id' => "0day信息论坛id",
	...
	'text_oday_bot_id' => "0day机器人的数字id，请点击机器人的名字查看。",
	'text_oday_forum_id' => "0day信息论坛的id，请点击该论坛查看。",
