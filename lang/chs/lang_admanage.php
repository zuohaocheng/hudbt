...
(
	...
	'text_end_time_note' => "时间格式为'年年年年-月月-日日 时时:分分:秒秒'，如'2008-01-24 21:00:00'。广告结束的时间。<br />如留空则广告永不结束，直到添加了新的广告。(md留空代码会报错，nnd --Cassius注)",
	...
	'text_image_url_note' => "广告图片文件的URL。<br />可使用相对地址（如'pic/ad.jpg'）或绝对地址（如'http://www.kmgtp.org/ad.jpg'）。",
	'text_image_link_note' => "广告指向的链接。如'http://www.kmgtp.org/ad.html'。",
	...
	'text_text_link_note' => "广告指向的链接。如'http://www.kmgtp.org/ad.html'。",
	...
	'text_flash_url_note' => "Flash文件的URL。<br />可使用相对地址（如'pic/flash.demo.swf')或绝对地址(如'http://www.kmgtp.org/flash.demo.swf'）。",
