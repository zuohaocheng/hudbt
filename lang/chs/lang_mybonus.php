...
(
	...
	'text_success_custom_title1' => "祝贺你，你获得了<strong>",
	'text_success_custom_title2' => "</strong>头衔！",
	...
	'text_enter_titile' => "你想要的<b>特殊头衔</b>: ",
...
<ul>",
	...
	'text_huh' => "恩？",
	'text_karma_self_giving_warning' => "哥们，你玩够了吗...<br />你不能将魔力值送给自己...<br />如果要送，选择其他用户面。",
	'text_receiver_not_exists' => "对不起...<br />不存在该用户。",
	'text_oups' => "啊哦!",
	'text_not_enough_karma' => "<b>对不起</b>，你没有足够的魔力值！",
	'text_cheat_alert' => "想作弊？没门！",
	'text_not_enough_bonus' => "对不起，你没有足够的魔力值。还有，你怎么到这来的？",
	'text_uploaded_one' => "1.0 GB",
	'text_uploaded_note' => "如果有足够的魔力值，你可以用它来换取上传量。交易完成后，你的魔力值会减少，上传量则会增加。",
	'text_uploaded_two' => "5.0 GB",
	'text_uploaded_three' => "10.0 GB",
	'text_uploaded' => "上传量",
...
式中<ul><li><b>A</b>为中间变量</li><li><b>Ti</b>为第<b>i</b>个种子的生存时间, 即自种子发布起到现在所经过的时间, 单位是周</li><li><b>T0</b>为参数。<b>T0</b> = ",
	...
	'text_per_hour' => "",
	'text_custom' => "自定义",
	'bonus_amount_not_allowed' => "魔力值数量不允许。你每次只能赠送25.0至10,000个魔力值。",
	...
	'text_tax_example_note' => "个魔力值。另外，最少可以赠送25个魔力值，最多也只能赠送10,000个。",
