...
(
	...
	'mail_five' => "在通过验证后，你就可以使用新账号了。<br /><br />如果你在24小时内没有通过验证，你的账号将被删除。<br />新人登录".$SITENAME."后请务必先阅读规则，提问前请参考常见问题。<br /><br />请注意：如果你并没有在".$SITENAME."网站注册，请举报此邮件至".$REPORTMAIL."<br /><br />------<br /><br />".$SITENAME." .",
