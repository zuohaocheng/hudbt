...
(
	...
	'text_client_banned_note' => "检查到你最近一次使用的BT客户端属于<b>未允许</b>的范畴。请阅读以下说明。",
	'text_low_ratio_notice' => "低分享率提示",
	'text_low_ratio_note_one' => "<span class='striking'><b>警告：</b></span>你的分享率过低！你必须在",
	'text_low_ratio_note_two' => "内改善它，否则你在本站的<b>账号将被系统自动封禁</b>。如果你不明白什么是分享率，请仔细阅读以下说明。",
	'text_first_time_download_notice' => "第一次下载提示",
	'text_first_time_download_note' => "Hi<br />这可能是你<b>第一次</b>在本站下载种子。<br />在此之前请仔细阅读下列内容。",
	...
	'text_private_tracker_note_two' => "要确保你的会员资格，你<b>必须</b>保持一个最低要求的上传量/下载量的比值（即<b>分享率</b>）。分享率过低将导致你<span class='striking'>失去在这里的会员资格</span>。",
	...
	'text_allowed_clients_note_one' => "BT客户端有很多种。但是在本站，我们<b>只</b>允许其中的部分。其它客户端（如比特彗星，迅雷）属于<span class='striking'>被禁止</span>范畴，我们的Tracker不会接受其连接请求。",
