...
(
	...
	'text_user_js_hints' => '本站有全局加载jQuery和jQuery UI，请自由使用。<br />若需加载他人的JavaScript，加入"<code>$.getScript("/cache/users/USERID.js");</code>"，替换其中的USERID即可，但请千万提防恶意代码。顺便一提，用户JavaScript在本页是不会加载的。<br />需加载他人的CSS样式，则使用"<code>$.getCSS("/cache/users/USERID.css");</code>"。',
	'text_user_css_hints' => '若需伸手别人的CSS，请移步<a href="usercp.php?action=js">JavaScript页面</a>',
	'text_user_css' => '用户CSS',
	...
	'checkbox_accepttdpms'=> "我下载过的种子被删除时通知我",//Added by bluemonster 20111107
	'row_gender' => "性别",
	...
	'row_quoted_comments' => "被引用的评论",
	'row_forum_posts' => "论坛帖子数",
	'row_quoted_posts' => "被引用的帖子",
