...
<?php
  ...
  if (is_null($CURUSER['color'])) {    
    $otheroptions[10]='<input type="color" id="color" class="color" name="color" value="#000000" disabled="disabled" /><label><input type="checkbox" id="color-default" name="color-default" value="1" checked="checked" />恢复默认颜色</label>';
  }
  else {
    $otheroptions[10]='<input type="color" id="color" class="color" name="color" value="#' . $CURUSER['color'] . '" /><label><input type="checkbox" id="color-default" name="color-default" value="1" />恢复默认颜色</label>';
  }
