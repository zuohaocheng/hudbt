...
for ($i=1; $i <=9; $i++)
{
	...
	print("<td class=\"rowfollow\" align='left'><h2>".$bonusarray['name']."</h2>".$bonusarray['description']."<br /><br />".$lang_mybonus['text_enter_titile'].$otheroption_title.$lang_mybonus['text_click_exchange']."</td><td class=\"rowfollow\" align='center'>".number_format($bonusarray['points'])."</td>");
	}
	elseif ($i==7){  //for Give A Karma Gift
			...
			print("<td class=\"rowfollow\" align='left'><h2>".$bonusarray['name']."</h2>".$bonusarray['description']."<br /><br />".$lang_mybonus['text_enter_receiver_name']."<br />$otheroption</td><td class=\"rowfollow nowrap\" align='center'>".$lang_mybonus['text_min']."25<br />".$lang_mybonus['text_max']."10,000</td>");
	}
	elseif ($i==9){  //charity giving
			...
			print("<td class=\"rowfollow\" align='left'><h2>".$bonusarray['name']."</h2>".$bonusarray['description']."<br /><br />".$lang_mybonus['text_select_receiver_ratio']."<br />$otheroption</td><td class=\"rowfollow nowrap\" align='center'>".$lang_mybonus['text_min']."1,000<br />".$lang_mybonus['text_max']."50,000</td>");
	}
	else{  //for VIP or Upload
		print("<td class=\"rowfollow\" align='left'><h2>".$bonusarray['name']."</h2>".$bonusarray['description']."</td><td class=\"rowfollow\" align='center'>".number_format($bonusarray['points'])."</td>");
	}
...
<?php
print("<h2>".$lang_mybonus['text_get_by_seeding']."</h2>");
print("<ul>");
...
print("<h2>".$lang_mybonus['text_other_things_get_bonus']."</h2>");
print("<ul>");
		...
		*note if they try to use a restricted word, they will recieve the special title "I just wasted my karma" *****/
		...
		elseif($art == "gift_1" && $bonusgift_bonus == 'yes') {
			...
			if($CURUSER['seedbonus'] >= $points) {
				...
				print("<table width=\"940\"><tr><td class=\"colhead\" align=\"left\" colspan=\"2\"><h2>".$lang_mybonus['text_oups']."</h2></td></tr>");
