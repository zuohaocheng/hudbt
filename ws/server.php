...
$server = new \Wrench\Server('ws://localhost:12345/', array(
...
require('PmApplication.php');
require('PmServerApplication.php');

$pm = new PmApplication();

$server->registerApplication('ws/pm', $pm);
$server->registerApplication('newpm', new PmServerApplication($pm));
$server->run();
