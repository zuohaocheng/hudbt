$(function() {
    "use strict";
    if ('SharedWorker' in window && 'WebSocket' in window && 
	(($.browser.webkit && parseFloat($.browser.version) >= 537) || !$.browser.webkit) && // there's some bug in webkit 535 and below
	'config' in hb && 'user' in hb.config) {
	var wsUrl = hb.constant.url.base;
	...
	worker.port.addEventListener("message", function(e) {
	    ...
	    // 		hb.constant.url.base + '/pic/icon.png',
	    // 		'新短讯!',
	    // 		'点击查看'
	    // 	    );

	    // 	    notification.onclick = function () {
	    // 		window.open(hb.constant.url.base + "/messages.php");
	    // 		notification.close();
	    // 	    }
	    // 	    notification.show();
	    // 	} else {
