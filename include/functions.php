...
function begin_compose($title = "",$type="new", $body="", $hassubject=true, $subject="", $maxsubjectlength=100) {
  ...
  if ($hassubject)
    print("<tr><td class=\"rowhead\">".$lang_functions['row_subject']."</td>" .
	  "<td class=\"rowfollow\" align=\"left\"><input type=\"text\" style=\"width: 650px;\" name=\"subject\" required=\"required\" maxlength=\"".$maxsubjectlength."\" placeholder=\"主题\" value=\"".$subject."\" /></td></tr>\n");
